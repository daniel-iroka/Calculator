    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            CalculatorTheme {
               ...
               // TODO - "THIS IS A MAJOR TASK THAT I WILL ACCOMPLISH LATER IN THIS PROJECT WHICH IS THE DESIGNING OF THE LANDSCAPE ADAPTIVE LAYOUT OF THIS APP ONLY " +
                       // todo "IF IT'S POSSIBLE AND NOT TO DIFFICULT."
